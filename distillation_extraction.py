...
def steal(model, teacher_model, dataset, evalset, num_epochs, device, do_eval=False, epoch_eval=5,  opt=None, lr_scheduler=None, savedir='./model.pt', save_iter=10, policy='soft', T=20.0, alpha=0.7, stop_acc=0.99):
    ...
    train_student_acc = []
    test_student_acc = []
# num_workers changed from 8 to 2
    ...
    eval_train_dataloader = DataLoader(eval_trainset, batch_size=BATCH_SIZE, shuffle=True, num_workers=2)
    eval_test_dataloader = DataLoader(eval_testset, batch_size=BATCH_SIZE, shuffle=True, num_workers=2)
...
if __name__ == '__main__':
    ...
    for i in range(args.num_models):
        ...
        steal(student_model, teacher_model, dataset=args.dataset, evalset=args.evalset,
            num_epochs=50, device=args.device, do_eval=True, epoch_eval=5, 
